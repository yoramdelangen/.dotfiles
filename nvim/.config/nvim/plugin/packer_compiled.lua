...
_G.packer_plugins = {
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  playground = {
    loaded = true,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/yoram/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
